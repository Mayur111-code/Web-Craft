...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    window.location.href =
      'https://web-craft.onrender.com/api/user/google';
  };
      ...
      >
        ...
        <form onSubmit={handleManualLogin} className="space-y-5">
          ...
          <div>
            ...
            <input
              type="email"
              className="w-full mt-1 px-4 py-3 bg-gray-800 rounded-lg text-white"
              value={email}
          ...
          <button
            disabled={isLoading}
            className="w-full py-3 bg-indigo-600 rounded-lg text-white font-bold"
          >
        ...
        <button
          onClick={handleGoogleLogin}
          className="w-full py-3 border border-gray-700 rounded-lg text-white hover:bg-gray-800"
        >
          Continue with Google
        </button>
